...
vim.diagnostic.handlers.underline = {
  show = require("dupa.utils.custom-lsp-handlers").remove_multiline_underline_handler,
  hide = vim.diagnostic.handlers.underline.hide,
}

vim.diagnostic.handlers.virtual_text = {
  show = require("dupa.utils.custom-lsp-handlers").add_source_to_virtual_text_handler,
