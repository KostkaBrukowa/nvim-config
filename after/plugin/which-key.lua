...
local mappings = {
  ...
  ["f"] = {
    ...
    ["L"] = {
      "<cmd>lua require('dupa.utils.telescope-custom-pickers').last_picker()<CR>",
    ...
    ["t"] = { "<cmd>lua require('other-nvim').open('test')<CR>", "Find test file" },
    ["o"] = {
      "<cmd>lua require('dupa.utils.telescope-custom-pickers').open_saved_project_picker()<CR>",
      "Projects",
    },
    ["w"] = {
      "<cmd>lua require('dupa.utils.telescope-custom-pickers').open_file_from_word()<CR>",
  ...
  ["g"] = {
    ...
    ["b"] = {
      "<cmd>lua require('dupa.utils.telescope-custom-pickers').checkout_remote_smart()<CR>",
      "Branches",
    },
    ["m"] = {
      "<cmd>lua require('dupa.utils.telescope-custom-pickers').merge_branch()<CR>",
      "Git merge",
    },
  ...
  ["u"] = {
    ...
    ["t"] = {
      "<cmd>lua require('dupa.utils.treesitter-utils').goto_translation()<CR>",
      "Go to translation",
    },
    ["e"] = {
      "<cmd>lua require('dupa.utils.treesitter-utils').goto_main_export()<CR>",
      "Go to translation",
    },
    ["r"] = {
